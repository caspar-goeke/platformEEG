...
%% remove behavioral trials of epochs removed

removeEpochs = [2,4,13,23,36,47,53,56,97];
...
EEG = pop_saveset(EEG, 'filename', '32_session3_block3_epochs_16_Cleaned_ICA.set','filepath',strcat(path_data,'epochs_16/')); 